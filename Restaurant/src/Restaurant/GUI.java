...
public class GUI {
    ...
    public static void main(String[] args) {
         ...
         */
        Tables r1 = new Tables(1 ,"Single" , true);
        Tables r2 = new Tables(2 ,"Double" , true);
        Tables r3 = new Tables(3 ,"Triple" , true);
        Tables r4 = new Tables(4 ,"Single" , true);
        Tables r5 = new Tables(5 ,"Double" , true);
        Tables r6 = new Tables(6 ,"Triple" , true);
        Tables r7 = new Tables(7 ,"Single" , true);
        Tables r8 = new Tables(8 ,"Double" , true);
        Tables r9 = new Tables(9 ,"Triple" , true);
        Tables r10 = new Tables(10 ,"Suite" , true);
        
        /**
         * Aggregate all initialized rooms into an array to represent them collectively.
         */
        // Create an array of Tables to add to a Hotel object
    ...
    // amenities tab start
     ...
     // add elements to nested panels   
        ...
        */
        ...
        tableType = new JComboBox<>(new String[]{"Single", "Double", "Triple", "Suite"});
        ...
        public void actionPerformed(ActionEvent e){
            ...
            if (firstName.getText().isEmpty() || lastName.getText().isEmpty() || email.getText().isEmpty()
                ...
                Reservation R = new Reservation(adults1, children1, checkIn1String, checkOut1String, tableType1String, message1String);
                ...
                try {
                    String message = Restaurant.reserveRoom(G, tableType1String, checkIn1String, checkOut1String, email1String, bill);
                    if (message == null){
                        ...
                        Restaurant.reserveRoom1(G, tableType1String, checkIn1String, checkOut1String, email1String);
